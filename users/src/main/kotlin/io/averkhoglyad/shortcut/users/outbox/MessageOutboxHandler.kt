...
class MessageOutboxHandlerImpl(
    ...
    private fun whileHasPortionToProcess(block: (List<MessageOutboxEntity>) -> Unit) {
    ...
    private fun <B> ProducerRecord<String, B>.withHeadersFor(message: MessageOutboxEntity): ProducerRecord<String, B> {
        return this.apply {
            headers()
